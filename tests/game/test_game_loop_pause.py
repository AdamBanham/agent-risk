...
class TestGameLoopPause(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.game_state = GameState.create_new_game(5, 2, 10)
        ...
        self.game_loop = GameLoop(
            ...
            num_players=2,
            starting_armies=5,
            play_from_state=self.game_state,
        )
    ...
    def test_toggle_pause_first_time(self):
        ...
        with patch("pygame.display.set_caption") as mock_caption:
            ...
            mock_caption.assert_called_with(
                "Agent Risk - Dynamic Board Simulation [PAUSED]"
            )
    ...
    def test_render_includes_pause_overlay_when_paused(self):
        ...
        with patch.object(self.game_loop, "_draw_pause_overlay") as mock_overlay, patch(
            "pygame.display.flip"
        ):

            # Test rendering when not paused
            self.game_loop.paused = False
            self.game_loop.render(0.5)
