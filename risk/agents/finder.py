...
class BTAgents(AgentFamily):
    ...
    class TYPES(Enum):
        ...
        DEFENSIVE = BTDefensiveAgent
        AGGRESSIVE = BTAggresiveAgent
...
class MCTSAgents(AgentFamily):
    ...
    class TYPES(Enum):
        ...
        DEFENSIVE = MCTSDefensiveAgent
        AGGRESSIVE = MCTSAggressiveAgent
...
class DPNAgents(AgentFamily):
    ...
    class TYPES(Enum):
        ...
        DEFENSIVE = DPNDefensiveAgent
        AGGRESSIVE = DPNAggressiveAgent
