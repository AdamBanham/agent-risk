...
class Fight:
    ...
    def fight_round(self) -> DiceRoll:
        ...
        dice_roll = DiceRoll(attacker_dice=attacker_dice, defender_dice=defender_dice)
    ...
    def can_continue(self) -> bool:
        ...
        """
        return (
            self.current_attackers > 0
            and self.current_defenders > 0
            and self.phase == FightPhase.ACTIVE
        )
    ...
    def get_battle_summary(self) -> str:
        ...
        if self.is_completed():
            ...
            summary += f"\nWinner: {winner}\n"
            summary += (
                f"Survivors: {survivors_att} attackers, {survivors_def} defenders"
            )
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"Fight(attacker_territory={self.attacker_territory_id}, "
